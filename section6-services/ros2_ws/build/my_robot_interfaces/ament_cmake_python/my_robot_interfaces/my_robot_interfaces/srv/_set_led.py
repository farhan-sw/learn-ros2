...
class Metaclass_SetLed_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if LedStates.__class__._TYPE_SUPPORT is None:
                LedStates.__class__.__import_type_support__()
...
class SetLed_Request(metaclass=Metaclass_SetLed_Request):
    ...
    _fields_and_field_types = {
        'ledstates': 'my_robot_interfaces/LedStates',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'msg'], 'LedStates'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_robot_interfaces.msg import LedStates
        self.ledstates = kwargs.get('ledstates', LedStates())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.ledstates != other.ledstates:
            return False
        return True
    ...
    @builtins.property
    def ledstates(self):
        """Message field 'ledstates'."""
        return self._ledstates

    @ledstates.setter
    def ledstates(self, value):
        if __debug__:
            from my_robot_interfaces.msg import LedStates
            assert \
                isinstance(value, LedStates), \
                "The 'ledstates' field must be a sub message of type 'LedStates'"
        self._ledstates = value
