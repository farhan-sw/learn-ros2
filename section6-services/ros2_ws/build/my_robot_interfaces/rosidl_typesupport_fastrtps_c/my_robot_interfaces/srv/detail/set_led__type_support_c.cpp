...
#include "my_robot_interfaces/msg/detail/led_states__functions.h"  // ledstates
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ledstates
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_robot_interfaces, msg, LedStates
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->ledstates, cdr))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_my_robot_interfaces__msg__LedStates(
    &(ros_message->ledstates), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // member: ledstates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_robot_interfaces__msg__LedStates(
