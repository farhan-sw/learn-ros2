...
bool my_robot_interfaces__srv__set_led__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // ledstates
    PyObject * field = PyObject_GetAttrString(_pymsg, "ledstates");
    if (!field) {
      return false;
    }
    if (!my_robot_interfaces__msg__led_states__convert_from_py(field, &ros_message->ledstates)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * my_robot_interfaces__srv__set_led__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // ledstates
    PyObject * field = NULL;
    field = my_robot_interfaces__msg__led_states__convert_to_py(&ros_message->ledstates);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "ledstates", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
