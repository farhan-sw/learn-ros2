...
struct SetLed_Request_
{
  ...
  : ledstates(_alloc, _init)
  {
    (void)_init;
  }

  // field types and members
  using _ledstates_type =
    my_robot_interfaces::msg::LedStates_<ContainerAllocator>;
  _ledstates_type ledstates;

  // setters for named parameter idiom
  Type & set__ledstates(
    const my_robot_interfaces::msg::LedStates_<ContainerAllocator> & _arg)
  {
    this->ledstates = _arg;
    return *this;
  }
  ...
  {
    if (this->ledstates != other.ledstates) {
      return false;
    }
    return true;
  }
