  ...
  std::ostream & out)
{
  ...
  {
    out << "ledstates: ";
    to_flow_style_yaml(msg.ledstates, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: ledstates
  {
    ...
    out << "ledstates:\n";
    to_block_style_yaml(msg.ledstates, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
...
struct has_fixed_size<my_robot_interfaces::srv::SetLed_Request>
  : std::integral_constant<bool, has_fixed_size<my_robot_interfaces::msg::LedStates>::value> {};

template<>
struct has_bounded_size<my_robot_interfaces::srv::SetLed_Request>
  : std::integral_constant<bool, has_bounded_size<my_robot_interfaces::msg::LedStates>::value> {};
